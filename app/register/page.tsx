...
export default function RegisterPage() {
    ...
    const codeParam: string = searchParams.get("code") || ""
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/register`, {
                ...
                body: JSON.stringify({
                    ...
                    password_confirmation: formData.confirmPassword, // souvent attendu par Laravel
            ...
            if (!response.ok) {
                ...
                alert(data.message || t("registration_error"))
                return
            }
            ...
            <div className="container mx-auto px-4 py-8 flex items-center justify-center min-h-[calc(100vh-80px)]">
                <Card className="shadow-xl w-full max-w-3xl">
                    ...
                    <CardContent className="p-6">
                        ...
                        {missingCode && (
                            <Card className="bg-red-50 border border-red-500 text-red-700 p-4 mb-6">
                                <CardHeader>
                                    <CardTitle>{t("registration_error")}</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    Vous devez fournir un code parrain dans l'URL pour poursuivre l'inscription.
                                </CardContent>
                            </Card>
                        )}

                        {/* Formulaire seulement si code présent */}
                        {!missingCode && (
                            <>
                                {currentStep === 1 && (
